...
function chitietsp(e, t, n) {
	...
	kythuat = -1 != e.innerHTML.indexOf("[kythuat]") ? e.innerHTML.substring(e.innerHTML.indexOf("[kythuat]") + 9, e.innerHTML.indexOf("[/kythuat]")) : "ThÄ‚Â´ng sĂ¡Â»â€˜ kĂ¡Â»Â¹ thuĂ¡ÂºÂ­t chĂ†Â°a Ă„â€˜Ă†Â°Ă¡Â»Â£c cĂ¡ÂºÂ­p nhĂ¡ÂºÂ­t";
	mota = -1 != e.innerHTML.indexOf("[mota]") ? e.innerHTML.substring(e.innerHTML.indexOf("[mota]") + 6, e.innerHTML.indexOf("[/mota]")) : "KhÄ‚Â´ng cÄ‚Â³ mÄ‚Â´ tĂ¡ÂºÂ£ cho sĂ¡ÂºÂ£n phĂ¡ÂºÂ©m nÄ‚ y";
	hinhanh = -1 != e.innerHTML.indexOf("[mota]") ? e.innerHTML.substring(e.innerHTML.indexOf("[hinhanh]") + 9, e.innerHTML.indexOf("[/hinhanh]")) : "KhÄ‚Â´ng cÄ‚Â³ hÄ‚Â¬nh Ă¡ÂºÂ£nh cho sĂ¡ÂºÂ£n phĂ¡ÂºÂ©m nÄ‚ y";
	e.innerHTML = -1 != e.innerHTML.indexOf("[tintuc]") ? '<div class="tintuc"><h2 class="newstitle"><a href="' + n + '">' + t + "</a></h2><p>" + tintuc + '</p><div class="clear"></div>': '<div class="w-detail group simpleCart_shelfItem"><div id="img_' + r + '" class="large-6 medium-6 column"><a class="th" href="' + s[0].src + '">' + i + ' </a><div class="addthis_toolbox addthis_default_style "><a class="addthis_button_preferred_1"></a><a class="addthis_button_preferred_2"></a><a class="addthis_button_preferred_3"></a><a class="addthis_button_preferred_4"></a><a class="addthis_button_compact"></a><a class="addthis_counter addthis_bubble_style"></a></div></div><div class="large-6 medium-6 column"><div class="title item_name">' + t + '</div><div class="w-giaban">GĂ­a bĂ¡n: <b class="item_price">' + u + "</b></div>" + o + '<br/><br/><div class="boxbuy"><div class="soluong"><input type="number" name="quantity" min="1" max="100" value="1" class="item_quantity"></div><div class="btnMore"><a title ="" target="_blank" href="javascript:void(0);" class="item_add addtocart" rel="' + r + '">Äáº·t HĂ ng</a></div></div></div><div class="clear"></div><div id="horizontalTab" class="r-tabs"><div class="tab-side r-tabs-nav"><div class="r-tabs-state-default r-tabs-tab"><a class="active" href="#tab-1">Chi tiáº¿t sáº£n pháº©m</a></div></div><div class="tabs-container">' + kythuat + "</div></div></div>"
}
...
function Cart() {
	...
	e.emailCheckout = function () {
		var e = this;
		e.entryURL = "http://lakashop123.blogspot.com/p/mua-hang.html";
